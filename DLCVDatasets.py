...
cifar_path = r'D:\Users\lian9\Documents\Germany\TU Dortmund\WiSe 2019-2020\Computer Vision - Deep Learning\Exercise 2 Linear Classifier\cifar-10-batches-py'
...
if __name__ == '__main__':
    ...
    for class_id in range(len(class_names)):
        ...
        plt.imshow(x_train[y_train == class_id][0].astype(
            np.uint8))  # plotting behaviour of imshow differs between float32 and uint8
